...
final class HotSearchWordsViewModel: ViewModelProtocol {
    ...
    func requestCompleteHandle() {
        let hotSearchWordsRequet = MoyaProvider<AppDelegateRequest>()
        requestObject = hotSearchWordsRequet.request(.hotSearchWords, completion: { result in
            switch result {
